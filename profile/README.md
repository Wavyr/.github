<a href="https://wavyr.com"><img src="https://raw.githubusercontent.com/Wavyr/.github/main/profile/header.png" alt="Wavyr. Your own intelligence stack. Built and deployed." width="100%"></a>

<br>

**Wavyr builds and deploys software that helps people run an independent intelligence stack:** their own context, their own agents, their own decisions. Owned, not rented.
...
Start with the local mode, no account needed:

```sh
npx sfora-cli init --local
```

<br>

<sub>[wavyr.com](https://wavyr.com) &nbsp;·&nbsp; [X](https://x.com/wavyrlabs) &nbsp;·&nbsp; [LinkedIn](https://www.linkedin.com/company/wavyr/) &nbsp;·&nbsp; Wavyr B.V., Rotterdam, the Netherlands</sub>
